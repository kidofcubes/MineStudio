...
online_dict = {
    ...
    "rollout_config": {
        ...
        "worker_config": {
            ...
            "video_fps": 20,
            "video_output_dir": "output/videos/craft",
        },
    ...
    "train_config": {
        ...
        "save_path": "/scratch/hekaichen/workspace/MineStudio/minestudio/online/run/output/craft"
    },
...
def policy_generator():
    ...
    policy = load_rocket_policy(ckpt_path).to("cuda")
    return policy